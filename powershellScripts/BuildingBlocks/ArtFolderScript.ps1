...
#and creates a new folder for a user, and give that single user full control
...
# Essentially, change this to the folder you from which you want to mirror the permissions
